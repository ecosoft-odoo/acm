...

{
    ...
    'data': [
        ...
        'acm_agreement_contract/data/agreement_data_v3.xml',
        'acm_agreement_contract/data/agreement_service_contract_data.xml',
        ...
        'acm_agreement_contract/data/product_pricelist_item_description_data.xml',
        ...
        'acm_agreement_contract/wizards/create_new_version_product_wizards.xml',
        ...
        'acm_reports/report/historical_rental_analysis_report.xml',
        'acm_reports/report/historical_occupancy_analysis_report.xml',
        'acm_reports/report/historical_rental_rate_analysis_report.xml',
